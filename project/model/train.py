...
from decision_transformer import TrainableDT
...
class DecisionTransformerGymDataCollator:
    ...
    def __init__(self, dataset) -> None:
        ...
        for epi in dataset:
            ...
            traj_lens.append(len(epi['observations']))
...
model.save_pretrained('/project/model/weights/')
